...
var _ plugin.IPlugin = new(IPWhitelistPlugin)
...
var _ server.IPostConnAcceptPlugin = new(IPWhitelistPlugin)

func (ipWhitelist *IPWhitelistPlugin) PostConnAccept(codecConn server.ServerCodecConn) error {
