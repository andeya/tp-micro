...
func NewLenWriter(buf *ChunkedWriter) LenWriter {
	off := buf.Len()
...
type Marshaler interface {
	MarshalBson(buf *ChunkedWriter, key string)
}
...
func MarshalToBuffer(buf *ChunkedWriter, val interface{}) (err error) {
...
func EncodeSimple(buf *ChunkedWriter, val interface{}) {
...
func EncodeField(buf *ChunkedWriter, key string, val interface{}) {
	encodeField(buf, key, reflect.ValueOf(val))
}

func encodeField(buf *ChunkedWriter, key string, val reflect.Value) {
...
func EncodeOptionalPrefix(buf *ChunkedWriter, etype byte, key string) {
	if key == "" {
		return
	}
...
func EncodePrefix(buf *ChunkedWriter, etype byte, key string) {
...
func EncodeString(buf *ChunkedWriter, key string, val string) {
...
func EncodeBinary(buf *ChunkedWriter, key string, val []byte) {
	EncodePrefix(buf, Binary, key)
	putUint32(buf, uint32(len(val)))
	buf.WriteByte(0)
	buf.Write(val)
...
func EncodeInt64(buf *ChunkedWriter, key string, val int64) {
	EncodePrefix(buf, Long, key)
	putUint64(buf, uint64(val))
}

// EncodeInt32 encodes an int32.
func EncodeInt32(buf *ChunkedWriter, key string, val int32) {
	EncodePrefix(buf, Int, key)
	putUint32(buf, uint32(val))
}

// EncodeInt encodes an int.
func EncodeInt(buf *ChunkedWriter, key string, val int) {
	EncodeInt64(buf, key, int64(val))
}

// EncodeUint64 encodes an uint64.
func EncodeUint64(buf *ChunkedWriter, key string, val uint64) {
	EncodePrefix(buf, Long, key)
	putUint64(buf, val)
}

// EncodeUint32 encodes an uint32.
func EncodeUint32(buf *ChunkedWriter, key string, val uint32) {
	EncodeUint64(buf, key, uint64(val))
}

// EncodeUint encodes an uint.
func EncodeUint(buf *ChunkedWriter, key string, val uint) {
	EncodeUint64(buf, key, uint64(val))
}

// EncodeFloat64 encodes a float64.
func EncodeFloat64(buf *ChunkedWriter, key string, val float64) {
...
func EncodeBool(buf *ChunkedWriter, key string, val bool) {
...
func EncodeTime(buf *ChunkedWriter, key string, val time.Time) {
	EncodePrefix(buf, Datetime, key)
	mtime := val.UnixNano() / 1e6
	putUint64(buf, uint64(mtime))
}

func encodeStruct(buf *ChunkedWriter, key string, val reflect.Value) {
	EncodePrefix(buf, Object, key)
	encodeStructContent(buf, val)
}

func encodeStructContent(buf *ChunkedWriter, val reflect.Value) {
	lenWriter := NewLenWriter(buf)
	t := val.Type()
...
func encodeMap(buf *ChunkedWriter, key string, val reflect.Value) {
	EncodePrefix(buf, Object, key)
...
//   func (ps *PrivateStruct) MarshalBson(buf *ChunkedWriter, key string) {
// the map has to be using pointers, i.e:
//   map[string]*PrivateStruct
// and not:
//   map[string]PrivateStruct
// (see unit test)
func encodeMapContent(buf *ChunkedWriter, val reflect.Value) {
	lenWriter := NewLenWriter(buf)
	mt := val.Type()
...
func encodeSlice(buf *ChunkedWriter, key string, val reflect.Value) {
	EncodePrefix(buf, Array, key)
	encodeSliceContent(buf, val)
}

func encodeSliceContent(buf *ChunkedWriter, val reflect.Value) {
	lenWriter := NewLenWriter(buf)
	for i := 0; i < val.Len(); i++ {
...
func putUint32(buf *ChunkedWriter, val uint32) {
	Pack.PutUint32(buf.Reserve(WORD32), val)
}

func putUint64(buf *ChunkedWriter, val uint64) {
